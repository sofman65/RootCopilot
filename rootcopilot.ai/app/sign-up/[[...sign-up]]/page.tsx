  ...
  return (
    <div className="min-h-screen w-full flex bg-neutral-950">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-neutral-900 via-neutral-900 to-neutral-950 items-center justify-center relative overflow-hidden">
        ...
        {/* Glowing orbs */}
        <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-purple-500/15 rounded-full blur-[120px]" />
        ...
        <div className="relative z-10 max-w-md px-8 text-center">
          ...
          <p className="text-lg text-neutral-400 mb-8">
            Start debugging smarter with AI-powered root cause analysis
          </p>
          ...
          <div className="space-y-4 text-left">
            ...
            <FeatureItem
              ...
              description="SOC2 compliant, team management built-in"
            />
            <FeatureItem
              title="Instant Setup"
              description="Create your organization in seconds"
            />
          </div>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-neutral-950 overflow-y-auto">
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-neutral-400">
              Get started with RootCopilot in minutes
            </p>
          </div>
